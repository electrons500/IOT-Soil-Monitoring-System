...
$(document).ready(function () {
    datatables = $('#activatedDevicesButAreOnsiteTable').DataTable({
        "ajax": {
            "url": "/Arduino/GetActivatedDevicesButAreOnsiteList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-light' style='background: #95C942;color:#ffffff;'  href='/Arduino/UpdateArduino?id=${data}' title='Edit'><span class='fas fa-edit'></span></a>
