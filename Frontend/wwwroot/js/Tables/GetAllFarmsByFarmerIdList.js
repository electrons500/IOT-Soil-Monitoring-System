...
$(document).ready(function () {
    datatables = $('#farmerFarmTable').DataTable({
        "ajax": {
            "url": "/Farm/GetAllFarmsByFarmerIdList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-light' href='/SoilData/ViewSoilDataFromDeviceByAdmin?id=${data}' title='Check soil data' style='background: #8E24AA;color:#ffffff;cursor:pointer'><span class='fas fa-temperature-half'></span></a>
                        <a class='btn btn-light' href='/Farm/UpdateFarm/${data}' title='Edit farm information' style='background: #95C942;color:#ffffff;cursor:pointer'><span class='fas fa-edit'></span></a>
