...
namespace Frontend.Migrations
{
    ...
    partial class IOTSMSDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Frontend.Models.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Arduino", b =>
                {
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Farm", b =>
                {
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.FarmMapLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Farmer", b =>
                {
                    b.Property<string>("FarmerId")
                        .HasColumnType("nvarchar(250)")
                        .HasMaxLength(250);
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.FarmerImage", b =>
                {
                    b.Property<int>("FarmerImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Gender", b =>
                {
                    b.Property<int>("GenderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Region", b =>
                {
                    b.Property<int>("RegionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.SoilCategory", b =>
                {
                    b.Property<int>("SoilCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.SoilData", b =>
                {
            ...
            modelBuilder.Entity("Frontend.Models.Data.ApplicationUser", b =>
                {
                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.Gender", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.Region", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Arduino", b =>
                {
                    b.HasOne("Frontend.Models.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Farm", b =>
                {
                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.Farmer", "Farmer")
                        .WithMany("Farm")
                    ...
                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.SoilCategory", "SoilCategory")
                        .WithMany("Farm")
                        .HasForeignKey("SoilCategoryId")
                        .HasConstraintName("FK_SoilCategory_Farm_")
                        .IsRequired();

                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.Arduino", "Arduino")
                        .WithMany("Farm")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.FarmMapLocation", b =>
                {
                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.Farm", "Farm")
            ...
            modelBuilder.Entity("Frontend.Models.Data.IOTSMSDBContext.Farmer", b =>
                {
                    b.HasOne("Frontend.Models.Data.IOTSMSDBContext.FarmerImage", "FarmerImage")
                        .WithMany("Farmer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Frontend.Models.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
