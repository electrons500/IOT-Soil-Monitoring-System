...
namespace Frontend.Models.Data.IOTSMSDBContext
{
    public partial class IOTSMSDBContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<Frontend.Models.Data.ViewModel.FarmMapLocationViewModel> FarmMapLocationViewModel { get; set; }

        public DbSet<Frontend.Models.Data.FarmMapLocationModel> FarmMapLocationModel { get; set; }

        public DbSet<Frontend.Models.Data.ViewModel.RegionViewModel> RegionViewModel { get; set; }
    }
}
