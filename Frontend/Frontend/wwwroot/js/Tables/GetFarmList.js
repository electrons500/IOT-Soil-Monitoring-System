...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-primary' href='/Farm/UpdateFarm/${data}' title='Edit farm information' ><span class='fas fa-edit'></span></a>
                        <a class='btn btn-secondary text-white' href='/Farm/GetFarmDetails?id=${data}' title='View farm information' style='cursor:pointer'><span class='fas fa-plus'>  </span></a>
