...
$(document).ready(function () {
    datatables = $('#SoildataTable').DataTable({
        "ajax": {
            "url": "/SoilData/SoilDataFromAllDevicesList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-light' href='/SoilData/ViewSoilDataByAdmin/${data}' title='View as charts' style='background: #95C942;color:#ffffff;cursor:pointer'><span class='fas fa-chart-line'></span></a>
