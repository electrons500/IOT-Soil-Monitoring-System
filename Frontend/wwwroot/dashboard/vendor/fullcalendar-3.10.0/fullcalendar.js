...
// NOTE: should use httpClientLeft/httpClientTop, but very unreliable cross-browser.
function gethttpClientRect(el, origin) {
    var offset = el.offset();
    ...
    return {
        left: left,
        right: left + el[0].httpClientWidth,
        top: top,
        bottom: top + el[0].httpClientHeight // httpClientHeight includes padding but NOT scrollbars
    };
}
exports.gethttpClientRect = gethttpClientRect;
...
function getScrollbarWidths(el) {
    var leftRightWidth = el[0].offsetWidth - el[0].httpClientWidth;
    var bottomWidth = el[0].offsetHeight - el[0].httpClientHeight;
    var widths;
...
exports.gethttpClientRect = util_1.gethttpClientRect;
...
var Scroller = /** @class */ (function (_super) {
    ...
    Scroller.prototype.lockOverflow = function (scrollbarWidths) {
        ...
        if (overflowX === 'auto') {
            overflowX = (scrollbarWidths.top || scrollbarWidths.bottom || // horizontal scrollbars?
                ...
                this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].httpClientWidth
        ...
        if (overflowY === 'auto') {
            overflowY = (scrollbarWidths.left || scrollbarWidths.right || // vertical scrollbars?
                // OR scrolling pane with massless scrollbars?
                this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].httpClientHeight
            // subtract 1 because of IE off-by-one issue
            ) ? 'scroll' : 'hidden';
        }
    ...
    Scroller.prototype.gethttpClientWidth = function () {
        return this.scrollEl[0].httpClientWidth;
    };
    Scroller.prototype.gethttpClientHeight = function () {
        return this.scrollEl[0].httpClientHeight;
    };
    ...
    CoordCache.prototype.queryBoundingRect = function () {
        ...
        if (this.els.length > 0) {
            ...
            if (!scrollParentEl.is(document) &&
                ...
                return util_1.gethttpClientRect(scrollParentEl);
            }
        }
        return null;
    };
...
var DragListener = /** @class */ (function () {
    ...
    DragListener.prototype.computeScrollBounds = function () {
        if (this.isAutoScroll) {
            ...
            // TODO: use gethttpClientRect in future. but prevents auto scrolling when on top of scrollbars
        }
    };
    ...
    DragListener.prototype.constrainScrollVel = function () {
        ...
        if (this.scrollTopVel < 0) { // scrolling up?
            ...
            if (el.scrollTop() + el[0].httpClientHeight >= el[0].scrollHeight) { // already scrolled all the way down?
                this.scrollTopVel = 0;
            }
        }
        if (this.scrollLeftVel < 0) { // scrolling left?
            ...
            if (el.scrollLeft() + el[0].httpClientWidth >= el[0].scrollWidth) { // already scrolled all the way right?
                this.scrollLeftVel = 0;
            }
        }
    };
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    // Returns a moment for the current date, as defined by the httpClient's computer or from the `now` option.
    ...
    // legacyQuery operates on legacy event instance objects
    Calendar.prototype.httpClientEvents = function (legacyQuery) {
