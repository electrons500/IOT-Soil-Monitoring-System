...
$(document).ready(function () {
    datatables = $('#unactivatedArduinoTable').DataTable({
        "ajax": {
            "url": "/Arduino/GetUnActivatedDevicesRegisterdByAgricExtensionOfficerList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>
                        ...
                        <a class='btn btn-light' style='background: #95C942;color:#ffffff;'  href='/Arduino/UpdateArduinoByOfficer?id=${data}' title='Edit'><span class='fas fa-edit'></span></a>
